          ...
          properties: {
            tipo: {
              ...
              description:
                ...
                "'requiere_humano': ÚLTIMO RECURSO -- solo cuando de verdad no lo puedes resolver tú: pide un diseño/levantamiento técnico completo de un sistema (cuántas cámaras, dónde, qué marca conviene para su caso -- eso requiere un asesor), reclamos o problemas con un servicio o cotización anterior, negociación de descuento, o pide explícitamente hablar con una persona. Un pedido concreto de productos puntuales del catálogo NUNCA es 'requiere_humano' aunque sea informal -- eso es 'cotizacion'. " +
