...
const MENSAJE =
  'Otra cosa, LÍDER: estoy ansioso por seguir aprendiendo de usted -- entre más me enseñe cómo trabaja, ' +
  'mejor le voy a armar las cotizaciones. Así que no dude en corregirme o darme detalles cuando algo no salga como espera, ' +
  'con eso mejoro cada vez más.';
